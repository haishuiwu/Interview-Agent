...
const envExample = await readFile(new URL('../../../interview-agent-back-end/interview-agent/.env.example', import.meta.url), 'utf8')
...
assert.match(backendReadme, /第一批灰度：只开启面试官朗读/, 'Backend README must document TTS-first rollout')
