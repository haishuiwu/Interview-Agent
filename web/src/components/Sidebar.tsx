  ...
  return (
    <div className="w-64 bg-gray-900 text-white flex flex-col h-screen">
      <div className="p-4 border-b border-gray-700">
        <h1 className="text-lg font-bold">Student-Coach</h1>
        <p className="text-xs text-gray-400 mt-1">自适应学习训练与知识掌握诊断</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-3">
        <p className="text-xs text-gray-500 px-2">历史学习诊断（开发中）</p>
      </div>
