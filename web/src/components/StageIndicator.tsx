...
const stages = [
  { key: 'learning_goal_analysis', label: '分析目标' },
  { key: 'learner_state_analysis', label: '诊断学情' },
  { key: 'rag_retrieval', label: '检索练习' },
  { key: 'training_planning', label: '规划训练' },
  { key: 'adaptive_training', label: '自适应训练' },
  { key: 'targeted_review', label: '针对性巩固' },
  { key: 'session_summary', label: '学习诊断' },
  { key: 'next_training_plan', label: '下一轮计划' },
]
